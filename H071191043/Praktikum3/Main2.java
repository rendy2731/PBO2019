...
public class Main2 {
    public static void main(String[] args) {
        ...
        String name = efr.next();
        System.out.println("role");
        String role = efr.next();

        Player2 player1 = new Player2 (name, role);
        System.out.println();
        System.out.println("+-----------------------------+");
        System.out.println("insert player 2");
        System.out.println("name");
        String name2 = efr.next();
        System.out.println("role");
        String role2 = efr.next();

        Player2 player2 = new Player2 (name2, role2);
        System.out.println();
        int p1 = 0;
        int p2 = 0;
        boolean turn = false;
