        ...
        if (cData.teraToGiga(9) == 9216){
            ...
            if (cData.teraToMega(16) == 16777216){
                ...
                if (cData.teraToKilo(1) == 1073741824){
                    System.out.println("Tera To Kilobyte = OK");
                }
                else{
                    System.out.println("Tera To Kilobyte = INCORRECT");
                    return;
                }
            }
            else{
                System.out.println("Tera To Megabyte = INCORRECT");
                return;
            }
        }
        else{
            System.out.println("Tera To Gigabyte = INCORRECT");
            return;
        }
        cData.stop();
        System.out.println("\n");
